<?php include './layouts/layoutTop2.php'?>
                    ...
                    <div class="header-main">
                                                        ...
                                                        <div class="row g-4">
                                                            <div class="col-xl-2 homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-one-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <div class="col-xl-2  homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-2.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-two-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                                <div class="homemenu-content text-center">
                                                                    <h4 class="homemenu-title">
                                                            ...
                                                            <div class="col-xl-2 homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-3.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-three-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                                <div class="homemenu-content text-center">
                                                                    <h4 class="homemenu-title">
                                                            ...
                                                            <div class="col-xl-2 homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-4.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-four-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                                <div class="homemenu-content text-center">
                                                                    <h4 class="homemenu-title">
                                                            ...
                                                            <div class="col-xl-2 homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-5.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-five-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                                <div class="homemenu-content text-center">
                                                                    <h4 class="homemenu-title">
                                                            ...
                                                            <div class="col-xl-2 homemenu">
                                                                <div class="homemenu-thumb">
                                                                    ...
                                                                    <div class="demo-button">
                                                                        <a href="index-6.php" class="theme-btn">Multi Page</a>
                                                                        <a href="index-six-page.php" class="theme-btn">One Page</a>
                                                                    </div>
                                                                </div>
                                                                <div class="homemenu-content text-center">
                                                                    <h4 class="homemenu-title">
                        ...
                        <div class="header-right d-flex justify-content-end align-items-center">
                           <div class="header-button">
                                <a href="contact.php" class="theme-btn bg-2">Get A Quote</a>
                           </div>
               ...
               <div class="row g-4 align-items-center justify-content-between align-items-center">
                    <div class="col-lg-6">
                        <div class="hero-content">
                            ...
                            <p class="wow fadeInUp" data-wow-delay=".5s">
                                We specialize in delivering innovative solutions that drive business growth and enhance brand visibility. 
                                Our expert team combines data-driven strategies with creative thinking to help you achieve your business goals.
                            </p>
                            <div class="about-author">
                                ...
                                <div class="author-image wow fadeInUp" data-wow-delay=".5s">
                                    <img src="assets/img/about/face-mans-2.png" alt="author-img">
                                    <div class="content">
                                        <h6>
                    ...
                    <div class="col-lg-5 wow fadeInUp" data-wow-delay=".4s">
                       <div class="hero-image">
                            <img src="assets/img/hero/digital-marketing-hero-img-min.png" alt="img">
                    ...
                    <div class="row g-4 align-items-center justify-content-between">
                        <div class="col-lg-6 wow fadeInUp" data-wow-delay=".3s">
                           <div class="digital-about-image">
                                <img src="assets/img/about/digittal-about-img.png" alt="img">
                           </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="about-content">
                                ...
                                <div class="about-button wow fadeInUp" data-wow-delay=".5s">
                                    <a href="about.php" class="theme-btn bg-2">
                                        Learn More Us
        ...
        <section class="service-section-4 fix bg-cover section-padding" id="services" style="background-image: url('assets/img/service/service-bg-min.jpg');">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-box-items">
                            ...
                            <div class="content">
                                <h3><a href="service-details.php">Keyword Research</a></h3>
                                <p>
                                    We conduct thorough keyword research to identify the most effective keywords for your business, helping you to improve your search engine rankings and drive targeted traffic to your website.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-box-items active">
                            ...
                            <div class="content">
                                <h3><a href="service-details.php">Social Media Marketing</a></h3>
                                <p>
                                    Our social media marketing services help you build a strong online presence, engage with your audience, and drive traffic to your website through targeted campaigns on platforms like Facebook, Instagram, and Twitter.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="service-box-items">
                            ...
                            <div class="content">
                                <h3><a href="service-details.php">Email Marketing</a></h3>
                                <p>
                                    We create and manage effective email marketing campaigns that engage your audience and drive conversions.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="service-box-items">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    We specialize in delivering high-quality content that engages your audience and drives results. Our team of skilled writers creates compelling blog posts, articles, and website copy tailored to your brand's voice and goals.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="service-box-items">
                            ...
                            <div class="content">
                                ...
                                <p>
                                    We create responsive and user-friendly websites that drive results. Our team of experienced developers utilizes the latest technologies and best practices to build websites that not only look great but also perform well in search engines.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="service-box-items">
                            ...
                            <div class="content">
                                <h3><a href="service-details.php">SEO Optimizations</a></h3>
                                <p>
                                    We conduct thorough keyword research to identify the most effective keywords for your business, helping you to improve your search engine rankings and drive targeted traffic to your website.
                                </p>
                            </div>
                ...
                <div class="row align-items-center justify-content-between">
                    ...
                    <div class="col-lg-3 wow fadeInUp" data-wow-delay=".3s">
                        <div class="arrow-image text-center">
                            <img src="assets/img/working-process/arrow-revers.png" alt="img">
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-4.png" alt="author-img">
                                    <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-5.png" alt="author-img">
                                    <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-6.png" alt="author-img">
                                    <div class="content">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-7.png" alt="author-img">
                                    <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-8.png" alt="author-img">
                                    <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-9.png" alt="author-img">
                                    <div class="content">
                    ...
                    <div class="swiper-slide">
                        <div class="testimonial-box-items">
                            <div class="testimonial-content">
                                <div class="author-image">
                                    <img src="assets/img/testimonial/client-10.png" alt="author-img">
                                    <div class="content">
                ...
                <div class="row">
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".3s">
                        <div class="news-card-items style-2">
                            <div class="news-image bg-cover" style="background-image: url('assets/img/news/07.jpg');"></div>
                            <div class="news-content">
                                ...
                                <a class="link-btn" href="news-details.php">Read More<i class="far fa-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".5s">
                        <div class="news-card-items style-2">
                            <div class="news-image bg-cover" style="background-image: url('assets/img/news/08.jpg');"></div>
                            <div class="news-content">
                                <p>November 25, 2024</p>
                                <h4>
                                    <a href="news-details.php">
                    ...
                    <div class="col-xl-4 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay=".7s">
                        <div class="news-card-items style-2">
                            <div class="news-image bg-cover" style="background-image: url('assets/img/news/09.jpg');"></div>
                            <div class="news-content">
                                <p>November 25, 2024</p>
                                <h4>
                                    <a href="news-details.php">
